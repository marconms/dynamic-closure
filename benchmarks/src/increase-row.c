...
int main(int argc, char* argv[]) {
    ...
    printf(ANSI_COLOR_YELLOW
        "o" ANSI_COLOR_RESET
        " - DynamicClosure: benchmarking DyC_IncreaseRow.c, Semiring: "
        "MIN PLUS FP64\n"
        "\t - Dataset: %s\n"
        "\t - Number of updates: %d\n",
        dataset, xnvals);
    ...
    LAGRAPH_TRY(DYC_GenerateUpdatesRow(&X, &I, &J, xnvals, -10, -100, nodes));
    ...
    if (out_dir != NULL) {
        ...
        asprintf(&content, "%s,DyC_IncreaseRow,%d,%f\n", "F", true,
